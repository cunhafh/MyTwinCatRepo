declare module TcHmi.Controls.Beckhoff {
    class TcHmiUserManagement extends TcHmi.Controls.System.TcHmiControl {
        ...
        /**
         * Sets the font size and calls the associated process function (procesHeadlineFontSize).
...
declare module TcHmi.Controls.Beckhoff.TcHmiUserManagementPopups {
    ...
    class NotificationPopup extends Popup {
         ...
         */
        constructor(element: HTMLElement, parentControl: TcHmi.Controls.Beckhoff.TcHmiUserManagement, text: string | {
            key: string;
            parameters?: any[];
        }, headline: string | {
            key: string;
