declare module TcHmi.Controls.Beckhoff {
    class TcHmiFileExplorer extends TcHmi.Controls.System.TcHmiControl {
        ...
        protected __hasDeleteAndCreatePermission: boolean;
         ...
         */
        protected __onUploadPressed: () => Promise<void>;
        /**
        ...
        /**
         * Show a file selection window and return the selected files.
         */
         ...
         */
        protected __showErrorPopup(headerText: Helpers.Popup.Localization, contentText: Helpers.Popup.Localization): Promise<void>;
        /**
